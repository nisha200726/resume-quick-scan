...
const stats = [
  { label: "Total users", value: "1,284", icon: Users, delta: "+12%" },
  { label: "Active jobs", value: "96", icon: Briefcase, delta: "+4%" },
  { label: "Resumes processed", value: "8,412", icon: FileText, delta: "+28%" },
  { label: "Uptime", value: "99.98%", icon: Activity, delta: "stable" },
];
